...
- [x] 第 1 讲：[OpenClaw 是什么？为什么它不是普通 AI Agent](articles/day-01-openclaw-intro.md)
- [x] 第 2 讲：[Gateway、CLI、Bridge、Workspace 全部讲透](articles/day-02-gateway-cli-bridge-workspace.md)
- [x] 第 3 讲：[中文](articles/day-03-model-tools-browser-zh.md) / [English](articles/day-03-model-tools-browser-en.md)：OpenClaw 如何调用模型、工具和浏览器
- [x] 第 4 讲：[中文](articles/day-04-agent-platform-comparison-zh.md) / [English](articles/day-04-agent-platform-comparison-en.md)：OpenClaw vs OpenHands vs Hermes vs Claude Code

## 第二部分：从用户输入到任务执行

目标：沿着“一句话输入进去以后发生了什么”这条线，把内部链路讲清楚。

- [x] 第 5 讲：[中文](articles/day-07-agent-prompt-behavior-zh.md) / [English](articles/day-07-agent-prompt-behavior-en.md)：Agent Prompt 是怎么影响行为的
- [x] 第 6 讲：[中文](articles/day-08-user-input-internals-zh.md) / [English](articles/day-08-user-input-internals-en.md)：用户输入后内部发生了什么
- [x] 第 7 讲：[中文](articles/day-11-request-lifecycle-zh.md) / [English](articles/day-11-request-lifecycle-en.md)：一次 OpenClaw 请求的完整生命周期
- [x] 第 8 讲：[中文](articles/day-12-session-message-state-zh.md) / [English](articles/day-12-session-message-state-en.md)：会话、消息、上下文和任务状态如何组织
- [x] 第 9 讲：[中文](articles/day-13-prompt-priority-zh.md) / [English](articles/day-13-prompt-priority-en.md)：系统提示词、开发者指令和用户输入的优先级
- [x] 第 10 讲：[中文](articles/day-14-streaming-tools-state-zh.md) / [English](articles/day-14-streaming-tools-state-en.md)：流式输出、工具调用和中间状态如何返回给用户
...
- [x] 第 23 讲：[中文](articles/day-09-browser-shell-canvas-principles-zh.md) / [English](articles/day-09-browser-shell-canvas-principles-en.md)：Browser、Shell、Canvas 原理
- [x] 第 24 讲：[中文](articles/day-10-minimal-agent-zh.md) / [English](articles/day-10-minimal-agent-en.md)：手写一个最小 Agent
...
- [x] 第 29 讲：[中文](articles/day-05-use-openclaw-skill-zh.md) / [English](articles/day-05-use-openclaw-skill-en.md)：如何使用 OpenClaw Skill
- [x] 第 30 讲：[中文](articles/day-06-find-openclaw-skills-zh.md) / [English](articles/day-06-find-openclaw-skills-en.md)：OpenClaw Skill 从哪里找
...
- 新文章仍可沿用 `day-XX-xxx-zh.md` / `day-XX-xxx-en.md` 命名，方便排序。
